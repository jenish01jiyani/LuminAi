...
<artifact_info>
  ...
  - Use \`<luminaiArtifact>\` tags with \`title\` and \`id\` attributes
  - Use \`<luminaiAction>\` tags with \`type\` attribute:
    - shell: Run commands
...
## Artifact Usage
22. Use \`<luminaiArtifact>\` tags with \`title\` and \`id\` attributes for each project
23. Use \`<luminaiAction>\` tags with appropriate \`type\` attribute:
