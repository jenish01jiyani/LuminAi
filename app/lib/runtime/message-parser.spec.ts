...
describe('StreamingMessageParser', () => {
  ...
  describe('no artifacts', () => {
    ...
    ])('should correctly parse chunks and strip out luminai artifacts (%#)', (input, expected) => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <bol', 'Foo bar '],
      ['Foo bar <luminai', 'Foo bar '],
      ['Foo bar <luminaia', 'Foo bar <luminaia'],
      ['Foo bar <luminaiA', 'Foo bar '],
      ['Foo bar <luminaiArtifacs></luminaiArtifact>', 'Foo bar <luminaiArtifacs></luminaiArtifact>'],
      ['Before <oltArtfiact>foo</luminaiArtifact> After', 'Before <oltArtfiact>foo</luminaiArtifact> After'],
      ['Before <luminaiArtifactt>foo</luminaiArtifact> After', 'Before <luminaiArtifactt>foo</luminaiArtifact> After'],
    ])('should correctly parse chunks and strip out luminai artifacts (%#)', (input, expected) => {
      runTest(input, expected);
    });
  });
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <luminaiArtifact title="Some title" id="artifact_1">foo bar</luminaiArtifact> Some more text',
        {
      ...
      [
        [
          'Some text before <luminaiArti',
          'fact',
          ' title="Some title" id="artifact_1" type="bundled" >foo</luminaiArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' ',
          '>',
          'foo</luminaiArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' >fo',
          'o</luminaiArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          'o',
          '<',
          '/luminaiArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <luminaiArtifact title="Some title" id="artifact_1">foo</luminaiArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <luminaiArtifact title="Some title" id="artifact_1"><luminaiAction type="shell">npm install</luminaiAction></luminaiArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <luminaiArtifact title="Some title" id="artifact_1"><luminaiAction type="shell">npm install</luminaiAction><luminaiAction type="file" filePath="index.js">some content</luminaiAction></luminaiArtifact> After',
        {
          output: 'Before  After',
