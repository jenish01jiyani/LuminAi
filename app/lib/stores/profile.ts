...
const storedProfile = typeof window !== 'undefined' ? localStorage.getItem('luminai_profile') : null;
...
export const updateProfile = (updates: Partial<Profile>) => {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('luminai_profile', JSON.stringify(profileStore.get()));
  }
};
