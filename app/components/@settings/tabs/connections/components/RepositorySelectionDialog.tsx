      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-[90vw] md:w-[600px] max-h-[85vh] overflow-hidden bg-white dark:bg-[#1A1A1A] rounded-xl shadow-xl z-[51] border border-[#E5E5E5] dark:border-[#333333]">
          <div className="p-4 border-b border-[#E5E5E5] dark:border-[#333333] flex items-center justify-between">
            <Dialog.Title className="text-lg font-semibold text-luminai-elements-textPrimary dark:text-luminai-elements-textPrimary-dark">
            ...
            <Dialog.Close
              ...
              className={classNames(
                ...
                'text-luminai-elements-textTertiary hover:text-luminai-elements-textPrimary',
                'dark:text-luminai-elements-textTertiary-dark dark:hover:text-luminai-elements-textPrimary-dark',
                'hover:bg-luminai-elements-background-depth-2 dark:hover:bg-luminai-elements-background-depth-3',
                'focus:outline-none focus:ring-2 focus:ring-luminai-elements-borderColor dark:focus:ring-luminai-elements-borderColor-dark',
              )}
            >
                  ...
                  <div className="space-y-4 mb-4">
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 px-4 py-2 rounded-lg bg-[#F5F5F5] dark:bg-[#252525] border border-[#E5E5E5] dark:border-[#333333] text-luminai-elements-textPrimary"
                      />
                      <button
                        onClick={() => setFilters({})}
                        className="px-3 py-2 rounded-lg bg-[#F5F5F5] dark:bg-[#252525] text-luminai-elements-textSecondary hover:text-luminai-elements-textPrimary"
                      >
                  ...
                  {selectedRepository ? (
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <label className="text-sm text-luminai-elements-textSecondary">Select Branch</label>
                        <select
                          value={selectedBranch}
                          onChange={(e) => setSelectedBranch(e.target.value)}
                          className="w-full px-3 py-2 rounded-lg bg-luminai-elements-background-depth-2 dark:bg-luminai-elements-background-depth-3 border border-luminai-elements-borderColor dark:border-luminai-elements-borderColor-dark text-luminai-elements-textPrimary dark:text-luminai-elements-textPrimary-dark focus:outline-none focus:ring-2 focus:ring-luminai-elements-borderColor dark:focus:ring-luminai-elements-borderColor-dark"
                        >
                          {branches.map((branch) => (
                            <option
                              key={branch.name}
                              value={branch.name}
                              className="bg-luminai-elements-background-depth-2 dark:bg-luminai-elements-background-depth-3 text-luminai-elements-textPrimary dark:text-luminai-elements-textPrimary-dark"
                            >
    ...
    <button
      ...
      className={classNames(
        ...
        active
          ...
          : 'bg-[#F5F5F5] dark:bg-[#252525] text-luminai-elements-textPrimary dark:text-white hover:bg-[#E5E5E5] dark:hover:bg-[#333333] border border-[#E5E5E5] dark:border-[#333333]',
      )}
    >
      {children}
    </button>
...
function RepositoryList({
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center py-8 text-luminai-elements-textSecondary">
  ...
  if (repos.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-8 text-luminai-elements-textSecondary">
  ...
  return (
    <div className="p-4 rounded-lg bg-[#F5F5F5] dark:bg-[#252525] border border-[#E5E5E5] dark:border-[#333333] hover:border-purple-500/50 transition-colors">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-2">
          <span className="i-ph:git-repository text-luminai-elements-textTertiary" />
          <h3 className="font-medium text-luminai-elements-textPrimary dark:text-white">{repo.name}</h3>
        </div>
        <button
          onClick={onSelect}
      ...
      {repo.description && <p className="text-sm text-luminai-elements-textSecondary mb-3">{repo.description}</p>}
      <div className="flex items-center gap-4 text-sm text-luminai-elements-textTertiary">
        {repo.language && (
