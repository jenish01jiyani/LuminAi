      ...
      >
        <div className="flex items-center justify-between gap-2 mt-8 mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h4 className="text-md font-medium text-luminai-elements-textPrimary">Service Status</h4>
              <p className="text-sm text-luminai-elements-textSecondary">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={classNames(
                ...
                'bg-luminai-elements-background-depth-3 hover:bg-luminai-elements-background-depth-4',
        ...
        <div className="p-4 bg-luminai-elements-background-depth-2 rounded-lg">
          <h5 className="text-sm font-medium text-luminai-elements-textPrimary mb-2">Test API Key</h5>
        ...
        {loading && serviceStatuses.length === 0 ? (
          <div className="text-center py-8 text-luminai-elements-textSecondary">Loading service statuses...</div>
        ) : (
                ...
                >
                  <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-sm font-medium text-luminai-elements-textPrimary">{service.provider}</h4>
                        <div className="space-y-1">
                          <p className="text-xs text-luminai-elements-textSecondary">
                            Last checked: {new Date(service.lastChecked).toLocaleTimeString()}
                          </p>
                          {service.responseTime && (
                            <p className="text-xs text-luminai-elements-textTertiary">
                              Response time: {Math.round(service.responseTime)}ms
                            </p>
                          )}
                          {service.message && (
                            <p className="text-xs text-luminai-elements-textTertiary">{service.message}</p>
                          )}
                        </div>
                      </div>
                    </div>
                  ...
                  {service.incidents && service.incidents.length > 0 && (
                    <div className="mt-2 border-t border-luminai-elements-borderColor pt-2">
                      <p className="text-xs font-medium text-luminai-elements-textSecondary mb-1">Recent Incidents:</p>
                      <ul className="text-xs text-luminai-elements-textTertiary space-y-1">
