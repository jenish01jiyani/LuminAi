  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-luminai-elements-borderColor bg-luminai-elements-background-depth-1 text-luminai-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-luminai-elements-textSecondary', className)} {...props} />;
  },
);
