  ...
  return (
    <AnimatePresence>
      ...
      >
        <div
          className={classNames(
            'bg-luminai-elements-item-backgroundAccent',
            'p-1 rounded-lg text-luminai-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-luminai-elements-item-backgroundAccent hover:bg-luminai-elements-artifacts-backgroundHover"
